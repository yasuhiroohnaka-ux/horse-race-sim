...
export function pickTanpukuPair(race, includeBodyWeight = false, applyDraw = true) {
  ...
  const widePick = valuePickBase
    ...
    : null;
  const opponentPick = winRunnerUp
    ? {
        ...winRunnerUp,
        scoreGap: round3(winPickBase.placeScore - winRunnerUp.placeScore),
        selectionReason: buildOpponentSelectionReason(winRunnerUp, winPickBase.placeScore - winRunnerUp.placeScore),
      }
    : null;
